...
export function EditButton({ video, refetch }: EditButtonProps) {
  ...
  //     .then((data) => {
  //       if (user.title !== video.title || user.description !== video.description || data.secure_url !== undefined) {
  //         const newVideoData = {
  //           ...videoData,
                    ...
                    <>
                          ...
                          <div className="flex flex-col gap-2 mt-4">
                            ...
                            <div className="mt-2">
                              <Input
                                ...
                                value={user.title}
                                className="block w-full rounded-md border-0 py-1.5 text-gray-200 shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-800 bg-gray-700 sm:text-sm sm:leading-6"
                              />
                            </div>

                            <Label
                              htmlFor="description"
                              className="block text-sm font-medium leading-6 text-gray-200 mt-4"
                            >
                              Description
                            </Label>
                            <div className="mt-2">
                      ...
                      <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        <Button
                          onClick={() => handleEdit()}
                          variant="default"
                          className="bg-neutral-800 mx-3 text-neutral-200 hover:bg-neutral-700"
                          disabled={loading}
                        >
                          {loading ? (
                            <>
