            ...
            {user?.followings.map((following) => (
              ...
              >
                <div className="flex items-center space-x-4">
                  <UserImage
                    className="h-12 w-12 rounded-full border border-indigo-400"
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <Button
                    variant={
                      following.viewerHasFollowed ? "secondary" : "default"
                    }
                    size="sm"
                    onClick={async () => {
                      setLoading(true);
                    ...
                    className={`rounded-lg px-4 py-2 text-indigo-300 shadow-md backdrop-blur-md transition-all hover:scale-105 hover:shadow-lg 
                      ${
                        following.viewerHasFollowed
