      ...
      <CardContent>
        {sessionData ? (
          <form onSubmit={handleCommentSubmit} className="mb-6">
            <Textarea
              ...
              className="mb-2 rounded-lg border-neutral-700 bg-neutral-800 text-neutral-300 focus:ring-neutral-500"
          ...
          <Button
            onClick={() => void signIn()}
            className="w-full bg-neutral-800 text-neutral-300 hover:bg-neutral-700"
          >
            Sign in to comment
          </Button>
        )}
        {comments
          ...
          .map(({ user, comment }) => (
            <div
              key={comment.id}
              className="mb-4 border-t border-neutral-700 pt-4"
            >
